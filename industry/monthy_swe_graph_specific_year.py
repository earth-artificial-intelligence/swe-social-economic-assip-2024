...
# Function to plot the monthly mean SWE for a specific year
def plot_monthly_mean_swe_for_year(year):
...
# Plot the monthly mean SWE for the year 2023
plot_monthly_mean_swe_for_year(2022)
